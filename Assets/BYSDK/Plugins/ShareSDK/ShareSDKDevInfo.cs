...
public class SinaWeiboDevInfo : DevInfo {
	...
	public string AppKey = Config.SinaWeiBo.AppKey;
	public string AppSecret = Config.SinaWeiBo.AppSecret;
    public string RedirectUrl = Config.RedirectUrl;
    public bool ShareByAppClient = false;
#elif UNITY_IPHONE
    public const int type = (int) PlatformType.SinaWeibo;
	public string app_key = Config.SinaWeiBo.AppKey;
	public string app_secret = Config.SinaWeiBo.AppSecret;
    public string redirect_uri = Config.RedirectUrl;
...
public class TencentWeiboDevInfo : DevInfo {
    ...
    public string AppKey =  Config.SinaWeiBo.AppKey;
    public string AppSecret = Config.SinaWeiBo.AppSecret;
    public string RedirectUri = Config.RedirectUrl;
#elif UNITY_IPHONE
    public const int type = (int) PlatformType.TencentWeibo;
    public string app_key = Config.SinaWeiBo.AppKey;
    public string app_secret = Config.SinaWeiBo.AppSecret;
...
public class QQ : DevInfo {
    ...
    public string AppId = Config.QQ.AppKey;
    public string AppKey = Config.QQ.AppSecret;
    public bool ShareByAppClient = true;
#elif UNITY_IPHONE
    public const int type = (int) PlatformType.QQ;
    public string app_id = Config.QQ.AppKey;
    public string app_key = Config.QQ.AppSecret;
    public string auth_type = "both";  //can pass "both","sso",or "web"
#endif
}
...
public class WeChat : DevInfo {
    ...
    public string AppId =  Config.WeiChat.AppKey;
    public string AppSecret = Config.WeiChat.AppSecret;
    public bool BypassApproval = false;
#elif UNITY_IPHONE
    public const int type = (int) PlatformType.WeChat;
    public string app_id = Config.WeiChat.AppKey;
    public string app_secret = Config.WeiChat.AppSecret;
#endif
}
...
public class WeChatFavorites : DevInfo {
    ...
    public string AppId = "wxc58517447050716a";
    public string AppSecret = "adee4889093905c53eeeb8c2d894f73c";
#elif UNITY_IPHONE
    public const int type = (int) PlatformType.WeChatFavorites;
    public string app_id = "wxc58517447050716a";
    public string app_secret = "adee4889093905c53eeeb8c2d894f73c";
#endif
}
...
public class Facebook : DevInfo {
    ...
    public string ConsumerKey = Config.FaceBook.AppKey;
    public string ConsumerSecret = Config.FaceBook.AppSecret;
    public string RedirectUrl = Config.RedirectUrl;
#elif UNITY_IPHONE
    public const int type = (int) PlatformType.Facebook;
    public string api_key = Config.FaceBook.AppKey;
    public string app_secret = Config.FaceBook.AppSecret;
    public string auth_type = "both";  //can pass "both","sso",or "web"
#endif
}
...
public class Twitter : DevInfo {
    ...
    public string ConsumerKey = Config.Twitter.AppKey;
    public string ConsumerSecret = Config.Twitter.AppSecret;
    public string CallbackUrl = Config.RedirectUrl;
#elif UNITY_IPHONE
    public const int type = (int) PlatformType.Twitter;
    public string consumer_key = Config.Twitter.AppKey;
    public string consumer_secret = Config.Twitter.AppSecret;
    public string redirect_uri = Config.RedirectUrl;
#endif
}
...
public class KaiXin : DevInfo {
    ...
    public string RedirectUri = "http://uuloong.com:808/gameservice/server/Appdownload/puzzle9";
#elif UNITY_IPHONE
    public const int type = (int) PlatformType.Kaixin;
    public string api_key = "358443394194887cee81ff5890870c7c";
    public string secret_key = "da32179d859c016169f66d90b6db2a23";
    public string redirect_uri = "http://uuloong.com:808/gameservice/server/Appdownload/puzzle9";
#endif
}
...
public class YouDao : DevInfo {
    ...
    public string oauth_callback = "http://uuloong.com:808/gameservice/server/Appdownload/puzzle9/";
#endif
}
...
public class FourSquare : DevInfo {
    ...
    public string RedirectUrl = "http://uuloong.com:808/gameservice/server/Appdownload/puzzle9";
#elif UNITY_IPHONE
...
public class QQSeries : DevInfo {
    ...
    public string app_id = "1105455710";
    public string app_key = "Du6gecd95r5e9wp7";
    public string auth_type = "both";  //can pass "both","sso",or "web"
#endif
}
