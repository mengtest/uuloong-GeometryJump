...
public class CBSettings : ScriptableObject {
    ...
    const string iOSExampleAppIDLabel = AdsConfig.CHARTBOOS_APPID_IOS;
    const string iOSExampleAppSignatureLabel = AdsConfig.CHARTBOOS_APPSECRET_IOS;
    ...
    const string androidExampleAppIDLabel = AdsConfig.CHARTBOOS_APPID_ANDROID;
    const string androidExampleAppSignatureLabel = AdsConfig.CHARTBOOS_APPSECRET_ANDROID;
    ...
    const string amazonExampleAppIDLabel = "";
    const string amazonExampleAppSignatureLabel = "";
