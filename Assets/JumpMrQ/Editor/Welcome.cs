...
namespace AppAdvisory.GeometryJump
{
	...
	public class Welcome : EditorWindow 
	{
		...
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		private const string ONLINE_DOC_URL = "https://dl.dropboxusercontent.com/u/8289407/Geometry%20Jump%20Asset%20Store/Documentation/html/annotated.html";
		private const string RATEUS_URL = "http://u3d.as/n6E";
		private const string NAME_OF_THE_GAME = "Geometry Jump";
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		...
		private const float height = 765;
